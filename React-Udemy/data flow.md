**[[Data]] flow** refers to how [[data]] moves through an [[application]]. In [[frontend]] development, especially with [[React]], [[data]] typically flows in a **unidirectional** manner — from parent to child [[components]] via [[props]].
